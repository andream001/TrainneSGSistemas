...
do while .t.
   ...
   do while nEmpregados > nContador
      ...
      @ 05,01 say AllTrim(Str(nContador+1))
      ...
      @ 15,01 say "IDADE              : "
      @ 15,18 say Str(nIdade,8,1)
      @ 15,28 say " ANOS"
      @ 15,40 say "TEMPO CONTRIBUICAO : "
      @ 15,59 say Str(nTempoContribuicao,8,1)

      @ 16,01 say "REMUNERACAO FINAL  : "
      @ 16,23 say Transform(nRemuneracaoFinal,"@E 99,999.99")
      ...
      if lAptoAposentar
         @ 17,01 say "*** APTO A APOSENTAR ***"
         @ 17,25 say "Homens: 61+30 anos"
         @ 18,25 say "Mulheres: 58+20 anos"
      else
         @ 17,25 say "NAO APTO A APOSENTAR"
      endif

      Inkey(2)
      if lastkey() == 27
         cMensagem := "PROCESSADO "
         cMensagem += AllTrim(Str(nContador+1))
   ...
   @ 17,02 say "Homens processados : "
   @ 17,22 say Str(nTotHomens)
   @ 17,32 say "(Apos: "
   @ 17,39 say Str(nHomensAposentados)
   @ 17,49 say "= "
   @ 17,52 say Str(nPercHomensApos,6,1)
   @ 17,60 say "%)"

   @ 18,02 say "Mulheres processadas: "
   @ 18,25 say Str(nTotMulheres)
   @ 18,37 say "(Apos: "
   @ 18,44 say Str(nMulheresAposentadas)
   @ 18,57 say "= "
   @ 18,60 say Str(nPercMulheresApos,6,1)
   @ 18,68 say "%)"

   @ 19,02 say "Tot. remun. aptos  : "
   @ 19,23 say Transform(nTotRemuAposentados,"@E 999,999.99")
   
   @ 20,02 say "Homens >91 anos    : "
   @ 20,23 say Str(nHomens91anos)
   
   @ 21,02 say "Mulheres adm. <2013: "
   @ 21,24 say Str(nMulheresAntes2013)
   
   @ 22,02 say "Mulheres pagam IRRF: "
   @ 22,24 say Str(nMulheresPagamIRRF)
